...
> **注意：** 您也可以使用 `file:![:memory:](https://cdn.learnku.com/assets/images/emoji/memory.png)?cache=shared` 替代文件路径。 这会告诉 SQLite 在系统内存中使用一个临时数据库。 \(查看 [SQLite 文档](https://www.sqlite.org/inmemorydb) 获取详情\)
...
对于其它不支持的数据，[我们鼓励且欢迎大家伙开发更多数据库类型的驱动！](https://learnku.com/docs/gorm/v2/write_driver)
